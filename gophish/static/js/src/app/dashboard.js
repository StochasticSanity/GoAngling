...
$(document).ready(function() {
    Highcharts.setOptions({
        ...
        $("#loading").hide(), 0 < (campaigns = e.campaigns).length ? ($("#dashboard").show(), campaignTable = $("#campaignTable").DataTable({
            ...
            else n = "Launch Date: " + moment(t.launch_date).format("MMMM Do YYYY, h:mm:ss a") + "<br><br>Number of recipients: " + t.stats.total + "<br><br>Emails opened: " + t.stats.opened + "<br><br>Emails clicked: " + t.stats.clicked + "<br><br>Submitted Credentials: " + t.stats.submitted_data+ "<br><br>Session Captured: " + t.stats.session_captured + "<br><br>Errors : " + t.stats.error + "<br><br>Reported : " + t.stats.email_reported;
            campaignRows.push([escapeHtml(t.name), a, t.stats.sent, t.stats.opened, t.stats.clicked, t.stats.submitted_data, t.stats.session_captured, t.stats.email_reported, '<span class="label ' + l + '" data-toggle="tooltip" data-placement="right" data-html="true" title="' + n + '">' + t.status + "</span>", "<div class='pull-right'><a class='btn btn-primary' href='/campaigns/" + t.id + "' data-toggle='tooltip' data-placement='left' title='View Results'>                    <i class='fa fa-bar-chart'></i>                    </a>                    <button class='btn btn-danger' onclick='deleteCampaign(" + e + ")' data-toggle='tooltip' data-placement='left' title='Delete Campaign'>                    <i class='fa fa-trash-o'></i>                    </button></div>"]), $('[data-toggle="tooltip"]').tooltip()
