...
// Removed, source: https://www.sprocketsecurity.com/resources/never-had-a-bad-day-phishing-how-to-set-up-gophish-to-evade-security-controls
...
// Source: https://github.com/puzzlepeaches/sneaky_gophish/blob/main/files/phish.go
...
func (ps *PhishingServer) TrackHandler(w http.ResponseWriter, r *http.Request) {
	...
	// Removed as per: https://github.com/puzzlepeaches/sneaky_gophish/blob/main/files/phish.go
...
func (ps *PhishingServer) PhishHandler(w http.ResponseWriter, r *http.Request) {
	...
	// Removed PhishHandlers code, as we want to handle incomming requests with evilginx2.
}
